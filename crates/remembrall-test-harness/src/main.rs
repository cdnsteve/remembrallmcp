//! RemembrallMCP test harness binary.
//!
//! Validates parser quality against a ground truth TOML file.
//!
//! Usage:
//!   remembrall-test --project /path/to/project --ground-truth /path/to/ground-truth.toml
...
fn print_report(gt: &GroundTruth, s: &Scores, cmp: &comparator::ComparisonResult) {
    println!("=== RemembrallMCP Parser Quality Report ===");
    println!(
        "Project: {} ({}) v{}",
